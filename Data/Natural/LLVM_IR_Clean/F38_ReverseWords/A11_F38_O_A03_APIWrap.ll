...
@__const.ReverseWords.space = constant [2 x i8] c" \00"
...
57:
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %59, i8* align 1 getelementptr inbounds ([2 x i8], [2 x i8]* @__const.ReverseWords.space, i32 0, i32 0), i64 2, i1 false)
  %60 = load i8*, i8** %2
