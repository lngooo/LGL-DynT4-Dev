...
22:
  ...
  %28 = load i32, i32* %3
  %29 = sdiv i32 %28, 100
  call void @append(i8* %27, i32 %29, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  br label %43
30:
  %31 = load i32, i32* %3
...
38:
  ...
  %40 = load i32, i32* %3
  %41 = sdiv i32 %40, 100
  call void @append(i8* %39, i32 %41, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0))
  br label %42
42:
  br label %43
43:
...
57:
  ...
  %63 = load i32, i32* %3
  %64 = sdiv i32 %63, 10
  call void @append(i8* %62, i32 %64, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  br label %78
65:
  %66 = load i32, i32* %3
...
73:
  ...
  %75 = load i32, i32* %3
  %76 = sdiv i32 %75, 10
  call void @append(i8* %74, i32 %76, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  br label %77
77:
  br label %78
78:
...
90:
  ...
  %94 = load i32, i32* %3
  %95 = sub nsw i32 %94, 5
  call void @append(i8* %93, i32 %95, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0))
  br label %106
96:
  %97 = load i32, i32* %3
  %98 = icmp eq i32 %97, 4
...
102:
  %103 = load i8*, i8** %4
  %104 = load i32, i32* %3
  call void @append(i8* %103, i32 %104, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0))
  br label %105
105:
  br label %106
106:
