...
define dso_local void @solve(i32 %0, i32 %1, i8* %2, i8* %3, i8* %4, i8* %5) {
  %7 = alloca i32
  %8 = alloca i32
  %9 = alloca i8*
  %10 = alloca i8*
...
22:
  %23 = load i32, i32* %3
  %24 = load i8*, i8** %4
  call void @solve(i32 %23, i32 100, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* %24)
  %25 = load i32, i32* %3
  %26 = load i8*, i8** %4
  call void @solve(i32 %25, i32 10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %26)
  %27 = load i32, i32* %3
  %28 = load i8*, i8** %4
  call void @solve(i32 %27, i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* %28)
  ret void
}
