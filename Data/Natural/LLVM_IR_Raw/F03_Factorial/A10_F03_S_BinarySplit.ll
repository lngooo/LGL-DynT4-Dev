...
define dso_local i64 @range_prod(i32 %0, i32 %1) {
  %3 = alloca i64
  %4 = alloca i32
  %5 = alloca i32
  %6 = alloca i32
...
18:
  ...
  %26 = load i32, i32* %4
  %27 = load i32, i32* %6
  %28 = call i64 @range_prod(i32 %26, i32 %27)
  %29 = load i32, i32* %6
  %30 = add nsw i32 %29, 1
  %31 = load i32, i32* %5
  %32 = call i64 @range_prod(i32 %30, i32 %31)
...
11:
  %12 = load i32, i32* %3
  %13 = call i64 @range_prod(i32 1, i32 %12)
  store i64 %13, i64* %2
  br label %14
14:
  %15 = load i64, i64* %2
