@__const.Base64Encode.table = constant [65 x i8] c"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\00"
...
define dso_local void @Base64Encode(i8* %0, i32 %1, i8* %2) {
  ...
  store i32 %1, i32* %5
  store i8* %2, i8** %6
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %11, i8* align 16 getelementptr inbounds ([65 x i8], [65 x i8]* @__const.Base64Encode.table, i32 0, i32 0), i64 65, i1 false)
  store i32 0, i32* %8
  store i32 0, i32* %9
  br label %14
14:
