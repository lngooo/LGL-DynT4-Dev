@__const.VowelCount.v = constant [10 x i8] c"aeiouAEIOU"
...
define dso_local i32 @VowelCount(i8* %0) {
  ...
  %6 = alloca i32
  store i8* %0, i8** %2
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %8, i8* align 1 getelementptr inbounds ([10 x i8], [10 x i8]* @__const.VowelCount.v, i32 0, i32 0), i64 10, i1 false)
  store i32 0, i32* %4
  br label %10
10:
  %11 = load i8*, i8** %2
