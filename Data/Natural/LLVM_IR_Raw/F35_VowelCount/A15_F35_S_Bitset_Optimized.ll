@__const.VowelCount.v = constant [11 x i8] c"aeiouAEIOU\00"
...
define dso_local i32 @VowelCount(i8* %0) {
  ...
  store i8* %0, i8** %2
  store i64 0, i64* %3
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %10, i8* align 1 getelementptr inbounds ([11 x i8], [11 x i8]* @__const.VowelCount.v, i32 0, i32 0), i64 11, i1 false)
  store i32 0, i32* %5
  br label %12
12:
  %13 = load i32, i32* %5
