...
define dso_local void @qIK(i8* %0, i32 %1, i8* %2) {
  %4 = alloca i8*
  %5 = alloca i32
  %6 = alloca i8*
  %7 = alloca i8*
  ...
  %11 = load i8*, i8** %6
  %12 = load i8*, i8** %7
  call void @k(i8* %9, i32 %10, i32 0, i8* %11, i32 0, i8* %12)
  ret void
}
define internal void @k(i8* %0, i32 %1, i32 %2, i8* %3, i32 %4, i8* %5) {
  %7 = alloca i8*
  %8 = alloca i32
  %9 = alloca i32
  %10 = alloca i8*
...
122:
  ...
  %137 = load i8*, i8** %12
  call void @k(i8* %130, i32 %131, i32 %133, i8* %134, i32 %136, i8* %137)
  br label %139
139:
  ret void
}
...
28:
  ...
  call void @qIK(i8* %31, i32 %32, i8* %33)
