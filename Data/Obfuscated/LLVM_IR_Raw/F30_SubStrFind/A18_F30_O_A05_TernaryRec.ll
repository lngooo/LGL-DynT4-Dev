...
define dso_local i32 @Ekk(i8* %0, i8* %1, i32 %2, i32 %3) {
  %5 = alloca i8*
  %6 = alloca i8*
  %7 = alloca i32
  %8 = alloca i32
...
23:
  ...
  %28 = add nsw i32 %27, 1
  %29 = load i32, i32* %8
  %30 = call i32 @Ekk(i8* %25, i8* %26, i32 %28, i32 %29)
  br label %31
31:
...
define dso_local i32 @fN(i8* %0, i8* %1) {
  %3 = alloca i8*
  %4 = alloca i8*
  %5 = alloca i32
  store i8* %0, i8** %3
...
13:
  ...
  %15 = load i8*, i8** %4
  %16 = load i32, i32* %5
  %17 = call i32 @Ekk(i8* %14, i8* %15, i32 0, i32 %16)
  br label %18
18:
