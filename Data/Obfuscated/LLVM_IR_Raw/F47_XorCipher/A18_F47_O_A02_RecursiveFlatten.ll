@pDM.ir = internal global i32 0
@.str = constant [5 x i8] c"%02x\00"
@.str.1 = constant [2 x i8] c"\0A\00"
define dso_local void @pDM(i8* %0, i8* %1) {
  %3 = alloca i8*
  %4 = alloca i8*
  %5 = alloca i32
  store i8* %0, i8** %3
...
22:
  ...
  store i8 %35, i8* %31
  %36 = load i32, i32* @pDM.ir
  %37 = add nsw i32 %36, 1
  store i32 %37, i32* @pDM.ir
  %38 = load i8*, i8** %3
  %39 = getelementptr inbounds i8, i8* %38, i32 1
  store i8* %39, i8** %3
  br label %18
40:
  store i32 0, i32* @pDM.ir
  ret void
}
