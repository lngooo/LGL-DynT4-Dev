...
define dso_local void @Cr(i8* %0, i8* %1) {
  %3 = alloca i8*
  %4 = alloca i8*
  %5 = alloca i32
  %6 = alloca i32
...
22:
  ...
  %24 = load i8*, i8** %4
  %25 = load i32, i32* %5
  call void @vcS(i8* %23, i8* %24, i32 %25, i32 0)
  store i32 0, i32* %6
  br label %26
26:
  %28 = load i32, i32* %6
...
define internal void @vcS(i8* %0, i8* %1, i32 %2, i32 %3) {
  %5 = alloca i8*
  %6 = alloca i8*
  %7 = alloca i32
  %8 = alloca i32
...
17:
  ...
  %37 = load i32, i32* %8
  %38 = add nsw i32 %37, 1
  call void @vcS(i8* %34, i8* %35, i32 %36, i32 %38)
  br label %39
39:
  ret void
}
