...
define dso_local i32 @j0T(i32* %0, i32 %1, i32 %2, i32 %3) {
  %5 = alloca i32
  %6 = alloca i32*
  %7 = alloca i32
  %8 = alloca i32
...
115:
  ...
  %120 = load i32, i32* %9
  %121 = call i32 @j0T(i32* %116, i32 %117, i32 %119, i32 %120)
  br label %129
122:
  %123 = load i32*, i32** %6
  %124 = load i32, i32* %14
  ...
  %126 = load i32, i32* %11
  %127 = load i32, i32* %9
  %128 = call i32 @j0T(i32* %123, i32 %125, i32 %126, i32 %127)
  br label %129
129:
...
51:
  ...
  %55 = sub nsw i32 %54, 1
  %56 = load i32, i32* %6
  %57 = call i32 @j0T(i32* %53, i32 0, i32 %55, i32 %56)
  store i32 %57, i32* %10
  %58 = load i32, i32* %10
