...
define dso_local i32 @c60x(i32* %0, i32 %1, i32 %2, i32 %3) {
  %5 = alloca i32
  %6 = alloca i32*
  %7 = alloca i32
  %8 = alloca i32
...
132:
  ...
  %137 = load i32, i32* %9
  %138 = call i32 @c60x(i32* %133, i32 %134, i32 %136, i32 %137)
  br label %146
139:
  %140 = load i32*, i32** %6
  %141 = load i32, i32* %11
  ...
  %143 = load i32, i32* %8
  %144 = load i32, i32* %9
  %145 = call i32 @c60x(i32* %140, i32 %142, i32 %143, i32 %144)
  br label %146
146:
...
51:
  ...
  %55 = sub nsw i32 %54, 1
  %56 = load i32, i32* %6
  %57 = call i32 @c60x(i32* %53, i32 0, i32 %55, i32 %56)
  store i32 %57, i32* %10
  %58 = load i32, i32* %10
