...
define dso_local i32 @W(i32* %0, i32 %1, i32 %2, i32 %3) {
  %5 = alloca i32
  %6 = alloca i32*
  %7 = alloca i32
  %8 = alloca i32
...
99:
  ...
  %102 = load i32, i32* %14
  %103 = load i32, i32* %9
  %104 = call i32 @W(i32* %100, i32 %101, i32 %102, i32 %103)
  store i32 %104, i32* %5
  store i32 1, i32* %15
  br label %117
105:
  ...
  %116 = call i32 @W(i32* %106, i32 %108, i32 %109, i32 %115)
  store i32 %116, i32* %5
  store i32 1, i32* %15
  br label %117
117:
...
51:
  ...
  %55 = sub nsw i32 %54, 1
  %56 = load i32, i32* %6
  %57 = call i32 @W(i32* %53, i32 0, i32 %55, i32 %56)
  store i32 %57, i32* %10
  %58 = load i32, i32* %10
