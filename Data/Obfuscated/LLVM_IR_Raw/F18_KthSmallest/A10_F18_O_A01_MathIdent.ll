...
define dso_local i32 @ni(i32* %0, i32 %1, i32 %2, i32 %3) {
  %5 = alloca i32
  %6 = alloca i32*
  %7 = alloca i32
  %8 = alloca i32
...
121:
  ...
  %126 = load i32, i32* %9
  %127 = call i32 @ni(i32* %122, i32 %123, i32 %125, i32 %126)
  br label %135
128:
  %129 = load i32*, i32** %6
  %130 = load i32, i32* %11
  ...
  %132 = load i32, i32* %8
  %133 = load i32, i32* %9
  %134 = call i32 @ni(i32* %129, i32 %131, i32 %132, i32 %133)
  br label %135
135:
...
51:
  ...
  %55 = sub nsw i32 %54, 1
  %56 = load i32, i32* %6
  %57 = call i32 @ni(i32* %53, i32 0, i32 %55, i32 %56)
  store i32 %57, i32* %10
  %58 = load i32, i32* %10
